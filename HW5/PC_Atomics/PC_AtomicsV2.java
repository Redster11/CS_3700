...
public class PC_AtomicsV2
{
    ...
    public PC_AtomicsV2(int numOfPro, int numOfCon, int MaxSize, int itemsProduced)
    {
    ...
    public class Producer extends Thread
    {
        ...
        private PC_AtomicsV2 controller;
        Producer(PC_AtomicsV2 controller, int totalToMake, String name)
        {
    ...
    public class Consumer extends Thread
    {
        ...
        public Consumer(PC_AtomicsV2 controller, String name)
        {
            this.controller = controller;
            this.setName(name);
        }
    ...
    public static void main(String[] args) 
    {
        ...
        PC_AtomicsV2 pc = new PC_AtomicsV2(2, 5, 10, 100);
