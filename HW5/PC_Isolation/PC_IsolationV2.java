...
public class PC_IsolationV2{
    private Queue<Integer> que;
    private int MaxSize = 10;
    private volatile boolean canProduce;

    public PC_IsolationV2(int numOfPro, int numOfCon, int MaxSize, int itemsProduced)
    {
    ...
    {
        private PC_IsolationV2 controller;
        private boolean running;

        public Consumer(PC_IsolationV2 controller, String name)
        {
    ...
    public class Producer extends Thread
    {
        ...
        Producer(PC_IsolationV2 controller, int finalTotal, String ID)
        {
            total = finalTotal;
            this.controller = controller;
            this.setName(ID);
    ...
    public static void main(String[] args) 
    {
        ...
        PC_IsolationV2 pc = new PC_IsolationV2(2, 5, 10, 100);
